...
output_file_path_budget = os.path.join(script_dir, 'analysis', 'budget_analysis_output.txt') #points the data output file generated by the script to the subdirectory 'analysis' in the script working directory
output_file_path_election = os.path.join(script_dir, 'analysis', 'election_results_output.txt')
